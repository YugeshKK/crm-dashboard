    ...
    <>
      ...
      <div className="flex flex-col h-screen gap-4">
          ...
          <div className="flex flex-row gap-4 pb-8">
            ...
            <div className="flex flex-col gap-5">
              <div className="flex flex-row gap-4 items-center">
                ...
                <div className="bg-green-500 text-white px-2 py-1 rounded-xl text-sm">
                  Active
                </div>
              </div>
          ...
          <div className="flex flex-col gap-4 border border-gray-300 rounded-xl p-4 h-fit">
            ...
            <div className="flex flex-row gap-20">
              <div className="flex flex-col gap-1 align-items-center justify-center">
                ...
                <p className="text-green-600  rounded-xl w-fit  px-2 bg-green-50 text-center">
                  In stock
                </p>
              </div>
        ...
        <div className="flex flex-row gap-4 border-b-2 pb-2">
          <Button
            className={`flex items-center gap-2 ${activeTab === "overview" ? "border-green-200 bg-green-100 text-green-700 hover:bg-green-100" : ""}`}
            variant="outline"
          ...
          <Button
            variant="outline"
            className={`flex items-center gap-2 ${activeTab === "inventory" ? "border-green-200 bg-green-100 text-green-700 hover:bg-green-100" : ""}`}
          ...
          <Button
            variant="outline"
            className={`flex items-center gap-2 ${activeTab === "sp" ? "border-green-200 bg-green-100 text-green-700 hover:bg-green-100" : ""}`}
